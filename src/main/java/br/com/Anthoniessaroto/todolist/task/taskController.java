...
import br.com.Anthoniessaroto.todolist.utils.utils;
...
public class taskController 
{
    ...
    public ResponseEntity update(@RequestBody taskModel Taskmodel, @PathVariable UUID id,  HttpServletRequest request)
    {
        ...
        {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Usuario não tem permissão para aterar esta tarefa");
        }
